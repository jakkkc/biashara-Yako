  ...
  return (
    <div className="min-h-screen bg-navy flex selection:bg-gold/30">
      ...
      <main className={`flex-1 flex flex-col transition-all duration-300 ${collapsed ? 'ml-20' : 'ml-72'}`}>
        {/* Top Header */}
        <header className="h-20 bg-navy border-b border-slate-800 flex items-center justify-between px-8 sticky top-0 z-40 backdrop-blur-xl bg-navy/80">
          <div>
            <h2 className="text-xl font-bold text-white tracking-tight leading-none mb-1">Overview Dashboard</h2>
